...
import { hoursWorkedPerWeekSelectors } from '../selectors/hoursWorkedPerWeek.selectors';
import { generalSelectors } from '../selectors/general.selectors';

export class HoursWorkedPerWeekPage {
  readonly page: Page;
  ...
  constructor(page: Page) {
    this.page = page;
    const s = hoursWorkedPerWeekSelectors;
  ...
  /**
   * Fill in the hours worked per week input
  ...
  /**
   * Submit the hours worked per week form
   * @param hours - Number of hours worked per week
   */
